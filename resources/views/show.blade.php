            ...
            <div class="col-md-8 col-md-offset-2">
                <div class="panel panel-default">
                    ...
                    <table class="table table-bordered table-stars">
                        <tr>
                            <td><br>{{ isset($nearStars[0]->name) ? $nearStars[0]->name : 'Void' }} @if (isset($nearStars[0]->name)) <br> <a href="{{ url('/moving/North-West') }}">Rejoindre</a>  @endif</td>
                            <td><br>{{ isset($nearStars[1]->name) ? $nearStars[1]->name : 'Void' }} @if (isset($nearStars[1]->name)) <br><a href="{{ url('/moving/North') }}">Rejoindre</a> @endif</td>
                        ...
                        <tr>
                            ...
                            <td><br>{{ isset($nearStars[7]->name) ? $nearStars[7]->name : 'Void' }} @if (isset($nearStars[7]->name)) <br><a href="{{ url('/moving/South') }}">Rejoindre</a> @endif</td>
