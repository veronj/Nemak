...
<div class="container">
    ...
    <div class="row">
        <div class="col-md-2 bg-success">
            ...
            {{ Form::text('men', $orders['buy']['men']) }}
            {{ Form::label('lasers', 'Lasers') }}
            {{ Form::text('lasers', $orders['buy']['lasers']) }}
            {{ Form::label('ships', 'Navettes') }}
            {{ Form::text('ships', $orders['buy']['ships']) }}
            {{ Form::label('robots', 'Robots') }}
            {{ Form::text('robots', $orders['buy']['robots']) }}
            {{ Form::label('missiles', 'Missiles') }}
            {{ Form::text('missiles', $orders['buy']['missiles']) }}
            {{ Form::submit('Valider') }}
